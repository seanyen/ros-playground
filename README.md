...
| --- | --- | --- | --- |
| [![Conda Recipe](https://img.shields.io/badge/recipe-ros-green.svg)](https://anaconda.org/conda-forge/ros) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/ros.svg)](https://anaconda.org/conda-forge/ros) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/ros.svg)](https://anaconda.org/conda-forge/ros) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/ros.svg)](https://anaconda.org/conda-forge/ros) |
...
Once the `conda-forge` channel has been enabled, `ros` can be installed with:
...
```
conda search ros --channel conda-forge
```
